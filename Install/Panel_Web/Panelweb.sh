...
panel_v11 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v11/Painelv11.sh > /dev/null 2>&1; chmod +x Painelv11.sh; ./Painelv11.sh
}
panel_v11_2 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v11_2/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v12 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v12/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v15 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v15/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v15_2 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v15_2/ocspanel > /dev/null 2>&1; chmod +x ocspanel; ./ocspanel
}
panel_v20 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v20/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v20_mod () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v20_mod/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v23 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v23/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v25 () {
    wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/panel_v25/install > /dev/null 2>&1; chmod +x install; ./install
}
...
wget https://raw.githubusercontent.com/sauceisgood/ssh-manager/master/Install/Panel_Web/Panelweb.sh > /dev/null 2>&1
...
clear
echo -e "$barra"
echo -e "\E[41;1;37m        ⇱ INSTALAR O PAINEL SSH/DROP/SSL by @cccheckml ⇲        \E[0m"
echo -e "$barra"
